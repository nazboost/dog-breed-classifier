...
class Yolo(object):
    ...
    def _get_class(self):
        classes_path = os.path.join(os.path.abspath(
            os.path.dirname(__file__)), 'yolo_data/coco_classes.txt')
    ...
    def _get_anchors(self):
        anchors_path = os.path.join(os.path.abspath(
            os.path.dirname(__file__)), 'yolo_data/yolo_anchors.txt')
    ...
    def generate(self):
        model_path = os.path.join(os.path.abspath(
            os.path.dirname(__file__)), 'yolo_data/yolo.h5')
